app.bgm = (function() {
  ...
  var opt = {
    ...
    'src':'http://oydffb2sr.bkt.clouddn.com/musicbgm.mp3'
  };
//'src':'http://w.benbun.com/proj/shoufa/media/bgm1.mp3'
  var data = {
    audio: null,
    init: init,
    change: change,
  ...
  function initAudio() {
    ...
    console.log('loading',app.common.getQueryString('id'));
    if(app.common.getQueryString('id')){
    }else{
